...
import cn.lonelyme.bandbuddy.engine.AacM4aWriter
...
import cn.lonelyme.bandbuddy.data.StemRecord
...
class DemucsInferenceInstrumentedTest {
    ...
    fun stopCalibrationAndExportNoisyF1() {
        val context = ApplicationProvider.getApplicationContext<Context>()
        val repository = cn.lonelyme.bandbuddy.data.LocalSongRepository(context)
